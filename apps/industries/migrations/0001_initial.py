...
class Migration(migrations.Migration):
    ...
    operations=[migrations.CreateModel(name="Industry",fields=[("id",models.BigAutoField(auto_created=True,primary_key=True,serialize=False,verbose_name="ID")),("name",models.CharField(max_length=160)),("slug",models.SlugField(unique=True)),("summary",models.CharField(max_length=300)),("content",models.TextField()),("status",models.BooleanField(default=True))])]